...
| <code>GPU-P01</code> | The readiness check is source/CMake presence lint. | <code>.forge/scripts/validate-engine-frontier.ps1:8172-8179</code>. | Require runtime execution, production pass coverage, and a successful production render rather than symbol presence. |
...
- <code>.forge/scripts/validate-determinism-matrix.ps1:36-40,185-186</code> permits
  per-build baselines.

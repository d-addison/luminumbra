...
T-I4-DR-terrain-realism. This tool is NOT built by CMake; it is run by hand to
...
def write_provenance(summary):
    ...
    lines = [
        ...
        "",
        "Generated by `tools/derive_dem_stats.py` (T-I4-DR-terrain-realism).",
    ...
    lines += [
        ...
        "(iteration-6 erosion target); the same tiles/fixtures already serve it.",
        "",
    ]

...
def build_inventory(root: Path) -> dict:
    ...
    for relative in tracked(root):
        ...
        # Inventory the bytes Git publishes, not a checkout's transformed
        # working-tree bytes.  In particular, Windows may materialize text
        # assets with CRLF even though source archives contain the canonical
        # blob bytes.

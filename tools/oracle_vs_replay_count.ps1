# oracle_vs_replay_count.ps1 -- test-rigor-hardening (T002/AC-004).
#
...
[void]$sb.AppendLine("")
[void]$sb.AppendLine("Generated by ``tools/oracle_vs_replay_count.ps1`` (test-rigor-hardening, AC-004).")
...
[void]$sb.AppendLine("")
[void]$sb.AppendLine("## Standing note (FR-004)")
[void]$sb.AppendLine("")

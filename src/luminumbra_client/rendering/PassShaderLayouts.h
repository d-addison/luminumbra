...
// Spec 016 FR-D (GPU-05 + RENDER-13): the single, ENUMERABLE source of truth for
...
// enumerable without linking every pass TU — the RENDER-13 fixture test and the
// GPU-05 coverage gate both need the full list. It is also what spec 014's SPIRV-Cross
...
// RENDER-13 fixture test uses this to load each entry's real shader and validate it.

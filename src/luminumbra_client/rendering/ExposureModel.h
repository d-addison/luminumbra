...
// time-of-day exposure curve (A-T05). BOTH the client push site (main_client.cpp)
...
// lighting pass; it NEVER feeds world_hash (spec 018 FR-E-003). Because it is not
...
// (== m_pillarA_exposure default) -- the analytic TOD curve's DAY value.
...
// WINS over the analytic time-of-day base (A-T05); a negative override (the -1

...
// Spec 016 (016-P1): DirectionalLight + PointLight moved to RenderFrameTypes.h (included above). Definitions unchanged.
...
// Spec 016 (016-P1): FrameBufferObject moved to FrameBufferObject.h (included above). Definition unchanged.
...
// Spec 016 (016-P1): enum class WeatherType moved to RenderFrameTypes.h (included above). Definition unchanged.

// Spec 016 (016-P1): WeatherRenderState moved to RenderFrameTypes.h (included above). Definition unchanged.

// Spec 016 (016-P1): CloudRenderState moved to RenderFrameTypes.h (included above). Definition unchanged.

// Spec 016 (016-P1): LightningRenderState (+ kMaxBoltSegmentPoints) moved to RenderFrameTypes.h (included above). Definition unchanged.

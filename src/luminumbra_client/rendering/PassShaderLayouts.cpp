...
// The single source of truth (GPU-05 + RENDER-13). One entry per render-pass SHADER
...
const std::vector<PassShaderLayout>& AllPassShaderLayouts() {
    static const std::vector<PassShaderLayout> kLayouts = [] {
        ...
        v.push_back({"gbuffer_geometry", "res/shaders/g_buffer.vert", "res/shaders/g_buffer.frag",
            [] {
                ExpectedLayout e;
        ...
        v.push_back({"gbuffer_impostor", "res/shaders/tree_impostor.vert", "res/shaders/tree_impostor.frag",
            [] {
                ExpectedLayout e;
        ...
        v.push_back({"ssao_bilateral_upsample", "res/shaders/ssao.vert", "res/shaders/ssao_bilateral_upsample.frag",
            [] {
                ExpectedLayout e;
        ...
        v.push_back({"lighting", "res/shaders/lighting_pass.vert", "res/shaders/lighting_pass.frag",
            [] {
                ExpectedLayout e;
        ...
        v.push_back({"lightning_overlay", "res/shaders/lightning_overlay.vert", "res/shaders/lightning_overlay.frag",
            [] {
                ExpectedLayout e;
        ...
        v.push_back({"weather_overlay", "res/shaders/ssao.vert", "res/shaders/weather_system.frag",
            [] {
                ExpectedLayout e;
        ...
        // --- ParticlePass ---------------------------------------------------
        v.push_back({"magical_particles", "res/shaders/magical_particles.vert", "res/shaders/magical_particles.frag",
            [] {
                ExpectedLayout e;
        ...
        // --- DebugViewPass --------------------------------------------------
        v.push_back({"debug_view", "res/shaders/fullscreen_tri.vert", "res/shaders/debug_view.frag",
            [] {
                ExpectedLayout e;
        ...
        // --- GroundDecalPass ------------------------------------------------
        v.push_back({"scent_decal", "res/shaders/fullscreen_tri.vert", "res/shaders/scent_decal.frag",
            [] {
                ExpectedLayout e;
...
const PassShaderLayout* FindPassShaderLayout(std::string_view layout_name) {
    for (const auto& entry : AllPassShaderLayouts()) {
        if (entry.layout_name == layout_name) return &entry;
    }
    return nullptr;
}

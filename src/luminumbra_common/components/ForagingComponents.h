...
// T-I9-AI E3 (FR-3): ant-trail FORAGING via stigmergy — the components for the Deneubourg
...
// These are pure data, in their own header (no wide EnTT recompile blast radius), and are an OPT-IN:
// a world with no ForagerComponent runs ForagingSystem as a no-op, so the canonical roster's
// world_hash is byte-identical.

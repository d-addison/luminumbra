...
public:
    ...
    [[nodiscard]] int extent_cells() const noexcept { return extent_cells_; }
    [[nodiscard]] float cell_size_m() const noexcept { return cell_size_m_; }
    [[nodiscard]] std::size_t stride() const noexcept {
        return static_cast<std::size_t>(extent_cells_);
    }
    [[nodiscard]] std::size_t cell_count() const noexcept {
        return static_cast<std::size_t>(extent_cells_) *
               static_cast<std::size_t>(extent_cells_);
    }
    ...
    [[nodiscard]] std::int64_t origin_cell_x() const noexcept { return origin_cell_x_; }
    [[nodiscard]] std::int64_t origin_cell_z() const noexcept { return origin_cell_z_; }
    ...
    [[nodiscard]] T& at(int lx, int lz) { return cells_[index(lx, lz)]; }
    [[nodiscard]] const T& at(int lx, int lz) const { return cells_[index(lx, lz)]; }

    [[nodiscard]] std::vector<T>& cells() noexcept { return cells_; }
    [[nodiscard]] const std::vector<T>& cells() const noexcept { return cells_; }

...
// T-I9-AI E2: ScentDepositSystem — the WRITE side of stigmergy. Each tick, every
...
inline ScentDepositStats RunScentDepositOnTick(entt::registry& registry, ScentField& field,
    ...
    for (auto e : emitters) {
        ...
        if (s.scent_channel < 0 || s.scent_deposit <= 0.0f) continue;
